...
const validators = {
  ...
  REACT_APP_FEATURE_DASHBOARD_TABS: bool({ default: true }),
  REACT_APP_ZERION_API_KEY: str(),
  REACT_APP_FEATURE_DEFI_DASHBOARD: bool({ default: true }),
  REACT_APP_ZAPPER_API_KEY: str(),
  REACT_APP_COVALENT_API_KEY: str(),
  REACT_APP_FEATURE_LIFI_SWAP: bool({ default: true }),
  REACT_APP_FEATURE_COWSWAP: bool({ default: true }),
  REACT_APP_FEATURE_COWSWAP_GNOSIS: bool({ default: true }),
  REACT_APP_FEATURE_JAYPEGZ: bool({ default: false }),
  REACT_APP_FEATURE_OSMOSIS_SEND: bool({ default: true }),
  REACT_APP_FEATURE_OSMOSIS_LP: bool({ default: true }),
  REACT_APP_FEATURE_OSMOSIS_LP_ADDITIONAL_POOLS: bool({ default: true }),
  REACT_APP_FEATURE_OSMOSIS_STAKING: bool({ default: true }),
  REACT_APP_FEATURE_OSMOSIS_SWAP: bool({ default: true }),
  REACT_APP_FEATURE_OPTIMISM: bool({ default: true }),
  REACT_APP_FEATURE_BNBSMARTCHAIN: bool({ default: true }),
  REACT_APP_FEATURE_POLYGON: bool({ default: true }),
  REACT_APP_FEATURE_GNOSIS: bool({ default: true }),
  REACT_APP_FEATURE_ZRX_SWAP: bool({ default: true }),
  REACT_APP_FEATURE_THOR_SWAP: bool({ default: true }),
  REACT_APP_FEATURE_IDLE: bool({ default: true }),
  REACT_APP_FEATURE_YAT: bool({ default: false }),
  REACT_APP_FEATURE_AXELAR: bool({ default: true }),
  REACT_APP_FEATURE_SAVERS_VAULTS: bool({ default: true }),
  REACT_APP_FEATURE_WALLET_CONNECT_TO_DAPPS: bool({ default: true }),
  REACT_APP_FEATURE_WALLET_CONNECT_TO_DAPPS_V2: bool({ default: true }),
  REACT_APP_FEATURE_COINBASE_WALLET: bool({ default: true }),
  REACT_APP_FEATURE_WALLET_CONNECT_V2: bool({ default: true }),
  ...
  REACT_APP_OSMOSIS_ALLOW_LOW_LIQUIDITY_POOLS: bool({ default: true }),
